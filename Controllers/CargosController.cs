...
namespace ProjetoSupermercado.Controllers
{
    ...
    public class CargosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nome,descricao,salario,quantidade")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,descricao,salario,quantidade")] Cargo cargo)
        {
            if (id != cargo.id)
            {
                return NotFound();
